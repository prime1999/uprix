const MissionVission = () => {
  return (
    <main className="flex flex-col items-center justify-center mt-20 mb-8 mx-auto md:w-8/12 lg:w-1/2">
      ...
      <div className="w-full mt-8 flex items-center gap-2">
        <div className="bg-slate-200 h-36 w-1/2 rounded-lg p-4 text-md">
        ...
        <div className="bg-slate-200 h-36 rounded-lg p-4 w-1/2 text-md">
