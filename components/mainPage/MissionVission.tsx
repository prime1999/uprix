const MissionVission = () => {
  return (
    <main className="flex flex-col items-center justify-center mt-20 mb-8 mx-auto w-11/12 md:w-8/12 lg:w-1/2">
      <h1 className="text-2xl font-bold text-secondary-blue tracking-tighter">
        Why Join Uprix?
      </h1>
      <p className="text-center">
        ...
        <br />
        <br />
        <span className="font-semibold pt-4 text-secondary-blue">
          The right circle → Real Growth → Accountablity
        </span>
      </p>
      <div className="w-full mt-8 flex items-center gap-2">
        <div className="bg-blue-100 h-48 md:h-36 w-1/2 rounded-lg p-4 text-md">
        ...
        <div className="bg-blue-100 h-48 md:h-36 rounded-lg p-4 w-1/2 text-md">
